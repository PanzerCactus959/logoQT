    ...
    <div className="flex h-screen flex-col overflow-y-auto overflow-x-hidden bg-[#343434] md:flex-row">
      ...
      <div className="flex w-full flex-col md:flex-row">
        ...
        <div className="flex w-full flex-col pt-12 md:pt-0">
          ...
          <div className="relative flex flex-grow items-center justify-center px-4 py-8">
            <div className="relative w-full max-w-2xl">
              {generatedSvgs.length > 0 ? (
                <>
                  <div
                    className={`grid grid-cols-2 gap-4 transition ${isLoading ? "pointer-events-none opacity-40" : ""}`}
                  >
                    {generatedSvgs.map((svg, i) => (
                      <div
                        key={i}
                        className="group relative aspect-square rounded-xl bg-[#2C2C2C] p-4"
                      >
                        <div
                          className="h-full w-full [&_svg]:h-full [&_svg]:w-full"
                          // Mỗi SVG đã được backend trích xuất qua regex
                          // /<svg[\s\S]*?<\/svg>/ nên chỉ chứa 1 thẻ <svg>
                          // hợp lệ, không có script — an toàn để render.
                  ...
                  <div className="mt-4 flex justify-center">
                    <Button onClick={generateLogo} variant="secondary">
